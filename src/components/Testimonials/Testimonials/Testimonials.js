                    ...
                    <article className={styles.testimonials_article_info}>
                        <div className={styles.testimonials_info_content}>
                            ...
                            <div className={styles.testimonials_info_content_text}>
                                ...
                                <h5 className={styles.testimonials_info_name}>Konstantin Konstantinov</h5>
                            </div>
                        </div>
                    </article>
                    <article className={styles.testimonials_article_info}>
                        <div className={styles.testimonials_info_content}>
                            ...
                            <div className={styles.testimonials_info_content_text}>
                                ...
                                <h5 className={styles.testimonials_info_name}>Ivelina Ivanova</h5>
                            </div>
                        </div>
                    </article>
                    <article className={styles.testimonials_article_info}>
                        <div className={styles.testimonials_info_content}>
                            ...
                            <div className={styles.testimonials_info_content_text}>
                                ...
                                <h5 className={styles.testimonials_info_name}>Georgi Georgiev</h5>
                            </div>
                        </div>
                    </article>
                </div>
